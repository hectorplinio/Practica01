<?= $this->extend('Administration/base_layout') ?>
    ...
    <div class="toast" style=" height: 3em; position: absolute; margin-top: 2em; text-align: right;">
       ...
       <form class="formulario" id="formulario" method="POST" >
            <input style="display: none;" type="text" id="id" class="form-control" name="id" value="<?= $categories->id?>">
           <label class="form-label" for="name">Nombre</label>
           <input required type="text" id="name" class="form-control" name="name" value="<?= $categories->name?>">
